...
time_init = time.time()
print("Training SGD alpha = 0.00001")
clf = SGDClassifier(loss="hinge", penalty="l2", max_iter=5,alpha= 0.00001)
...
time_init = time.time()
print("Training SGD alpha = 0.0001")
clf = SGDClassifier(loss="hinge", penalty="l2", max_iter=5, alpha= 0.0001)
clf.fit(train_X, train_y)
print("Validating SGD")
y_hat = clf.predict(valid_X)
accuracy = accuracy_score(y_hat,valid_y)
...
time_init = time.time()
print("Training SGD alpha = 0.001")
clf = SGDClassifier(loss="hinge", penalty="l2", max_iter=5,alpha= 0.001)
clf.fit(train_X, train_y)
print("Validating SGD")
y_hat = clf.predict(valid_X)
accuracy = accuracy_score(y_hat,valid_y)
...
time_init = time.time()
print("Training SGD alpha = 0.01")
clf = SGDClassifier(loss="hinge", penalty="l2", max_iter=5,alpha= 0.01)
clf.fit(train_X, train_y)
print("Validating SGD")
y_hat = clf.predict(valid_X)
accuracy = accuracy_score(y_hat,valid_y)
